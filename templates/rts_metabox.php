            ...
            <tr>
                ...
                <td>
                    ...
                    foreach ($items as $key => $value) {
                        $selected = !empty($settings) && $settings['items'] == $key ? "checked" : "";
            ...
            <tr class="multiple_settings">
                ...
                <td>
                    ...
                    foreach ($center as $key => $value) {
                        $selected = !empty($settings) && $settings['center_mode'] == $key ? "checked" : "";
            ...
            <tr class="multiple_settings">
                ...
                <td>
                    ...
                    foreach ($lazy as $key => $value) {
                        $selected = !empty($settings) && $settings['lazy_load'] == $key ? "checked" : "";
            ...
            <tr id="fade">
                ...
                <td>
                    ...
                    foreach ($fade as $key => $value) {
                        $selected = !empty($settings) && $settings['fade'] == $key ? "checked" : "";
